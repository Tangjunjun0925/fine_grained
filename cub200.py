...
class CUB200(torch.utils.data.Dataset):
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None,
        ...
        if self._train:
            ...
            print('load the picked train data---finished!')
        else:
            ...
            print('load the picked test data---finished!')
    ...
    def _download(self, url):
        ...
        # Downloads file.
        fpath = os.path.join(self._root, 'CUB_200_2011.tgz')
        try:
        ...
        os.chdir(os.path.join(self._root))
        tar.extractall()
        tar.close()
        os.chdir(cwd)
    ...
    def _extract(self):
        ...
        print('Prepare the data for train/test split and save onto disk!------finished!')
...
#    CUB200(root='/Users/peggytang/Downloads/CUB_200_2011/')
